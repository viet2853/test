                    ...
                    <form class="space-y-4 md:space-y-6" action="#">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-start">
                                ...
                                <input id="remember" aria-describedby="remember" type="checkbox" class="w-4 h-4 border border-slate-300 rounded  focus:ring-3 focus:ring-primary-300 bg-slate-700 border-slate-600 focus:ring-primary-600 ring-offset-slate-800" required="">
                                </div>
                                <div class="ml-3 text-sm">
                                <label for="remember" class=" text-slate-300">Remember me</label>
                                </div>
                            </div>
                            <a href="#" class="text-sm font-medium hover:underline text-slate-300">Forgot password?</a>
                        </div>
                        <button type="submit" class="w-full text-white bg-slate-900 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-primary-600 hover:bg-primary-700 focus:ring-primary-800">Sign in</button>
                        <p class="text-sm font-light  text-slate-400">
                            Don’t have an account yet? <a href="/signup" class="font-medium  hover:underline text-slate-300">Sign up</a>
                        </p>
                    </form>
                </div>
            </div>
